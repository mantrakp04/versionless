...
function sheetOverlayClasses(blur: boolean, className?: string) {
  return cn(
    "fixed inset-0 z-50 bg-black/80 transition-opacity duration-200 ease-out data-ending-style:opacity-0 data-starting-style:opacity-0 motion-reduce:duration-150",
    blur
...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={sheetOverlayClasses(blur, className)}
      {...props}
    />
  );
}
